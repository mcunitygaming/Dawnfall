...
- **Height**: increase to 6 ft 7 in (200.66 cm)
- **Build**: Perfectly balanced musculature—neither bulky nor lean, optimized for both stability and speed.
...
- **Ice Magic**
    - Bairon condenses ice magic into the air surrounding a target, subtly suppressing thermal motion without forming visible frost or ice. Though not cold enough to freeze, the altered heat flow creates an unnatural stillness, as if the environment is hesitating to respond. Victims feel their breath grow heavier, their movements slightly delayed, and their reactions fractionally out of sync, like the space between intent and action has been stretched. Their skin prickles with a cold that never fully arrives, while their joints and muscles feel subtly resisted, as though motion is passing through thickened time rather than air. The effect triggers a quiet instinctive unease, slowing decision-making and tightening focus into hesitation, where even simple actions feel misaligned with expectation. Strong-willed individuals can resist the psychological pressure, but even they cannot fully ignore the sensation that the world around them is lagging behind Bairon’s precision.
